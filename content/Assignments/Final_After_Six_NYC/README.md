...
Then open `http://localhost:4173` in a browser. The presentation and rendered
notebook can be opened directly without running code. The generated 45 MB
walking GraphML is excluded from this course pull request; it can be recreated
from OpenStreetMap with the scripts in `scripts/`.
